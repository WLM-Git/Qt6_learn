/********************************************************************************
** Form generated from reading UI file 'widget_sample.ui'
**
...
#ifndef UI_WIDGET_SAMPLE_H
#define UI_WIDGET_SAMPLE_H
...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        chkBox_AcceptDrops->setObjectName("chkBox_AcceptDrops");

        gridLayout->addWidget(chkBox_AcceptDrops, 0, 0, 1, 1);

        chkBox_DragEnabled = new QCheckBox(groupBox_5);
        chkBox_DragEnabled->setObjectName("chkBox_DragEnabled");
        ...
        combo_DefaultAction->addItem(QString());
        combo_DefaultAction->addItem(QString());
        combo_DefaultAction->setObjectName("combo_DefaultAction");
